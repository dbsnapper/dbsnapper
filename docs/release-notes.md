...
A Terminal User Interface (TUI) has been added to the DBSnapper Agent, making it more even easier to use. See all your targets, drill down into their snapshots, and load them all from the new UI.
